...
export default function LiveExperienceSection() {
  ...
  return (
    <section id="features" style={{ padding: '70px 16px', background: 'rgba(9, 13, 25, 0.75)', position: 'relative' }}>
      <div className="container-custom" style={{ maxWidth: '1080px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <p style={{ fontSize: '15px', color: 'var(--color-text-sub)', maxWidth: '700px', margin: '0 auto' }}>
        ...
        <div className="glass-card" style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <h3 style={{ fontSize: 'clamp(20px, 3.5vw, 24px)', fontWeight: 900, color: '#FFFFFF', marginBottom: '8px' }}>
              ...
              <div style={{
                ...
                <div style={{ background: 'rgba(15, 23, 42, 0.8)', padding: '10px 14px', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.08)' }}>
                  <span style={{ fontSize: '10px', color: '#94A3B8', display: 'block' }}>FRAME RATE</span>
                  <strong style={{ fontSize: '15px', color: '#00E5FF' }}>{currentCategory.fps}</strong>
                </div>

                <div style={{ background: 'rgba(15, 23, 42, 0.8)', padding: '10px 14px', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.08)' }}>
                  <span style={{ fontSize: '10px', color: '#94A3B8', display: 'block' }}>BITRATE</span>
                  <strong style={{ fontSize: '15px', color: '#E91E63' }}>{currentCategory.bitrate}</strong>
                </div>

                <div style={{ background: 'rgba(15, 23, 42, 0.8)', padding: '10px 14px', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.08)' }}>
                  <span style={{ fontSize: '10px', color: '#94A3B8', display: 'block' }}>CODEC</span>
                  <strong style={{ fontSize: '15px', color: '#A855F7' }}>{currentCategory.codec}</strong>
                </div>

                <div style={{ background: 'rgba(15, 23, 42, 0.8)', padding: '10px 14px', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.08)' }}>
                  <span style={{ fontSize: '10px', color: '#94A3B8', display: 'block' }}>STREAM LATENCY</span>
                  <strong style={{ fontSize: '15px', color: '#10B981' }}>1.2 Seconds</strong>
                </div>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '6px' }}>
                <span style={{ fontSize: '11px', fontWeight: 800, color: '#00E5FF', display: 'flex', alignItems: 'center', gap: '4px' }}>
                  <Activity size={14} /> SIGNAL STRENGTH: 100%
                </span>
                <span style={{ fontSize: '10px', color: '#94A3B8', background: 'rgba(255, 255, 255, 0.08)', padding: '3px 8px', borderRadius: '6px' }}>
                  BUFFER: 15.0s
                </span>
              </div>
